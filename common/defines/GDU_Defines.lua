...
NDefines.NGame.LAG_DAYS_FOR_LOWER_SPEED = 300 -- these defines are most likely hourly and not daily , rever to 100 and 130 if desyncs during someone lagging for 10 days
NDefines.NGame.LAG_DAYS_FOR_PAUSE = 100
NDefines.NGame.COMBAT_LOG_MAX_MONTHS = 5
...
NDefines.NGame.GAME_SPEED_SECONDS = { 2.0, 0.5, 0.2, 0.035, 0.0 }						-- after this many months remove the history of lost convoys to not bloat savegames and memory since there is no way to see them anyway
...
NDefines.NNavy.NAVAL_MINES_IN_REGION_MAX = 0.00001
...
NDefines.NIntel.ARMY_DEPLOYED_MANPOWER_COUNT_RANGE_INTEL_MIN = 0
NDefines.NIntel.ARMY_ARMY_COUNT_RANGE_INTEL_MIN = 0
NDefines.NIntel.NAVY_FLEET_COUNT_INTEL_MIN = 0
NDefines.NIntel.AIR_DEPLOYED_MANPOWER_COUNT_RANGE_INTEL_MIN = 0
